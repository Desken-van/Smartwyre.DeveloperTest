...
{
    public class FixedCashAmountTestsWithMock
    {
        [Fact]
        public async void Test1() // FixedCashAmount, Rebate && Product != null, same flags
        {
            ...
            var newRebate = new RebateEntity() { Identifier = "USD", Amount = 23, Percentage = 3, Incentive = IncentiveType.FixedCashAmount };
        ...
        public async void Test2() // FixedCashAmount, Rebate && Product != null, diff flags
        {
            ...
            var newRebate = new RebateEntity() { Identifier = "USD2", Amount = 54, Percentage = 3, Incentive = IncentiveType.FixedCashAmount };
        ...
        public async void Test3() // FixedCashAmount, Rebate && Product != null, diff flags 0 amount, volume, percentege
        {
            ...
            var newRebate = new RebateEntity() { Identifier = "USD3", Amount = 0, Percentage = 3, Incentive = IncentiveType.FixedCashAmount };
        ...
        public async void Test4() // Rebate && Product = null
        {
            ...
            var newRebate = new RebateEntity() { Identifier = "USD4", Amount = 12, Percentage = 3, Incentive = IncentiveType.FixedCashAmount };
